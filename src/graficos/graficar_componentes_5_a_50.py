...
x_clase = [5, 10, 15, 20, 25, 30, 35, 40, 45, 50] # Por ejemplo aca varío los vecinos de 10 a 100

K = 3 # K del k-cross-folding
...
promedio = 0
f = open('../resultados/variar_componentes_5_a_50_de_5/f1.tex', 'r')
for j in range(0, cant_iteraciones):
  for i in range(0, K):
...
f = open('../resultados/variar_componentes_5_a_50_de_5/hitrate.tex', 'r')
promedio = 0
for j in range(0, cant_iteraciones):
  for i in range(0, K):
    aux = float(f.readline()[:-1])
...
f = open('../resultados/variar_componentes_5_a_50_de_5/recalls.tex', 'r')
prom = 0
for j in range(0, cant_iteraciones):
  for i in range(0, K):
    for z in range(0, 10):
...
f = open('../resultados/variar_componentes_5_a_50_de_5/precisiones.tex', 'r')
for j in range(0, cant_iteraciones):
  for i in range(0, K):
    for z in range(0, 10):
