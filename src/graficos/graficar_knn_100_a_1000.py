...
x_clase = [1, 2] # Por ejemplo aca varío los vecinos de 10 a 100
...
promedio = 0
f = open('../resultados/KNN_vecinos_100_a_1000_step_100/f1.out', 'r')
for j in range(0, cant_iteraciones):
  for i in range(0, K): 
    asss = f.readline()[:-1]
    print asss
...
f = open('../resultados/KNN_vecinos_100_a_1000_step_100/hitrate.out', 'r')
promedio = 0
for j in range(0, cant_iteraciones):
  for i in range(0, K):
    asss = f.readline()[:-1]
...
f = open('../resultados/KNN_vecinos_100_a_1000_step_100/recalls.out', 'r')
prom = 0
for j in range(0, cant_iteraciones):
  for i in range(0, K):
    for z in range(0, 10):
...
f = open('../resultados/KNN_vecinos_100_a_1000_step_100/precisiones.out', 'r')
for j in range(0, cant_iteraciones):
  for i in range(0, K):
    for z in range(0, 10):
...
#promedio = 0
#f = open('../resultados/KNN_vecinos_100_a_1000_step_100/tiempos.out', 'r')
#for j in range(0, cant_iteraciones):
#  for i in range(0, K):
#    promedio += float(f.readline()[:-1])
#
...
plt.legend()
plt.savefig('../resultados/KNN_vecinos_100_a_1000_step_100/graficos/precisiones_clase.png')
plt.show()
...
plt.tight_layout()
plt.savefig('../resultados/KNN_vecinos_100_a_1000_step_100/graficos/precisiones_iteracion.png')
plt.show()
...
plt.tight_layout()
plt.savefig('../resultados/KNN_vecinos_100_a_1000_step_100/graficos/recall_clase.png')
plt.show()
...
plt.tight_layout()
plt.savefig('../resultados/KNN_vecinos_100_a_1000_step_100/graficos/recall_iteracion.png')
plt.show()
...
plt.tight_layout()
plt.savefig('../resultados/KNN_vecinos_100_a_1000_step_100/graficos/hitrate_promedio.png')
plt.show()
...
plt.tight_layout()
plt.savefig('../resultados/KNN_vecinos_100_a_1000_step_100/graficos/F1_promedio.png')
plt.show()
...
#
#plt.tight_layout()
#plt.savefig('../resultados/KNN_vecinos_100_a_1000_step_100/graficos/tiempos.png')
#plt.show()
